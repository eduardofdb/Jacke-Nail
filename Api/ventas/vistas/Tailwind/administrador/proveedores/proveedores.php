    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Proveedores</span>
        </div>
      </li>
    </ol>
  </div>
<div class="container mt-12">
         <a href="crear_proveedor.php" class="btn btn-outline-primary mt-4"><i class="fa-solid fa-circle-plus"></i></a>
         <table id="tabla" class="table table-bordered table-striped text-center mt-1">
               ...
               <tbody>
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
                     ...
                     <td>yurani8@gmail.com</td> 
                     <td>Cra 31A Nro 22-34</td>
                     <td>3044471789</td>
                     <td>Nivea</td>
                     <td>Activo</td>
                     <td>
...
<script>
   $(document).ready(function () {
      ...
      function confirmar_eliminar(idPedido){
    Swal.fire({
