...
<div class="container">
  <div class="relative  mx-4 my-12">
    <div class="relative shadow-md sm:rounded-lg">
      <table id="clientes" class="table table-bordered table-striped text-center mt-1">
        ...
        <tbody>
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 text-center">
            ...
            <td>302165145</td>
            <td>
                <button type="button" class="text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Activo</button>
            </td>
            <td>
