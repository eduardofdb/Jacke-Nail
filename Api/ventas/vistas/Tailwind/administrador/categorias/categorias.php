    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
      ...
      <li aria-current="page">
        <div class="flex items-center">
          ...
          <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Categorias de insumos</span>
        </div>
      </li>
    </ol>
  </div>
            ...
            <section class="bg-gray-50 dark:bg-gray-900 ">
              <div
                ...
                <div
                  ...
                  <div class="border-2 border-blue-300 rounded-lg p-6 space-y-6 sm:p-8">
                    <h1
          ...
          <table id="tabla" class=" table table-bordered border-black table-striped text-center mt-1 ">
            <thead style="background-color: #2b2929; color: white;">
              <tr>
                ...
                <th scope="col" style="text-align: center; vertical-align: middle;">NOMBRE CATEGORIA</th>
            ...
            <tbody>
              <tr>
                <td>1</td>
                <td><img width="50"
                    src=" https://cdnx.jumpseller.com/handandbeauty-cl/image/34954913/thumb/220/220?1683514712"
    ...
    $(document).ready(function () {
      $('#tabla').DataTable({
        language: {
          ...
          search: "Buscar&nbsp;:",
          lengthMenu: "Agrupar de _MENU_ categorias",
          info: "",
