                    ...
                    <form class="flex flex-col items-center space-y-6 md:space-y-8 p-1" action="#">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="flex items-center justify-center">
                                <button type="button" class="text-center text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Iniciar sesión</button>
                            </div>
                        </div>
