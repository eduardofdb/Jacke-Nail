...
<body>
      ...
      <table id="usuarios" class="table">
        <thead class="table-info">
          <tr>
            ...
            <th scope="col">Rol</th>
            <th scope="col"> <a class="cursor-pointer" data-modal-target="crud-modal" data-modal-toggle="crud-modal" type="button"><i class='bx bx-user-plus' ></i></a> Acciones </th>
          </tr>
        </thead>
        <tbody>
          <tr>
  ...
  <br>
  <li class="flex justify-between items-center">
    <span class="flex items-center">Eliminar</span>
    <a href="#" class="mr-8"><i class='bx bx-trash-alt' style='color:rgba(255,0,4,0.85)'></i></a>
  </li>
  <br>
  <li class="flex justify-between items-center">
        ...
        <div class="relative bg-white rounded-lg border-2 border-rose-900 shadow-rose dark:bg-gray-700">
          ...
          <form action="#" class="p-4 md:p-5 grid grid-cols-2 gap-4">
            ...
            <label for="category"
                ...
                placeholder="Empleado" required disabled>
